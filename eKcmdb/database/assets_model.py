...
class Host(models.Model):
    ...
    asset_name = models.SmallIntegerField(choices=host_type_choices, default=3, verbose_name='设备名称')
    manufactory = models.ForeignKey('Manufactory', null=True, blank=True, verbose_name="制造厂商")
    raid_type = models.SmallIntegerField(choices=raid_type_choices, default=0, verbose_name="RAID类型")
